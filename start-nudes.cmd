@echo off
rem Starts the nudes.xxx server on the LAN so phones on your Wi-Fi can use it.
...
if defined LANIP (
  echo nudes.xxx starting... open http://%LANIP%:8899 on your phone ^(same Wi-Fi^).
) else (
  echo nudes.xxx starting... no DHCP address found - check you're on Wi-Fi/Ethernet.
